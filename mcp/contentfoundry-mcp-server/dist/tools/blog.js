...
export function registerBlogTools(server) {
    server.registerTool("cf_list_blog_posts", {
        title: "List Blog Posts",
        description: "List published blog posts from ContentFoundry. Supports filtering by tag and pagination. Returns title, slug, description, date, and tag for each post.",
        inputSchema: {
            tag: z
                .string()
                .optional()
    ...
    server.registerTool("cf_get_blog_post", {
        title: "Get Blog Post",
        description: "Get a single published blog post by slug from ContentFoundry. Returns full content including sections, blocks, and SEO metadata.",
        inputSchema: {
    ...
    server.registerTool("cf_create_draft_blog_post", {
        title: "Create Draft Blog Post",
        description: "Create a new draft blog post in ContentFoundry. The post is saved as unpublished and can be reviewed in the admin dashboard before publishing. Requires a write-permission API key.",
        inputSchema: {
