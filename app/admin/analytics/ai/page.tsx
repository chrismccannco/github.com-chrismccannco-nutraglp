    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <select
          ...
          className="text-sm border border-neutral-300 rounded-lg px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-teal-500"
        >
          ...
          <div className="flex items-end gap-1 h-32">
            {data.daily.map((d) => {
              ...
              return (
                ...
                >
                  <div
                    className="bg-teal-500 rounded-t w-full min-h-[2px] transition-all hover:bg-teal-600"
                    style={{ height: `${pct}%` }}
                  />
