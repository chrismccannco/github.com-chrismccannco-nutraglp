...
function SparkLine({ data, maxVal }: { data: (number | null)[]; maxVal: number }) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      {trending === "down" && <TrendingDown className="w-3 h-3 text-emerald-600" />}
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="text-xs border border-neutral-300 rounded-lg px-2.5 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-emerald-500"
          >
      ...
      {loading && !data ? (
        ...
        <>
                  ...
                  data!.pages.map((p) => (
                    <button
                      ...
                      className={`w-full text-left px-5 py-3 flex items-center gap-3 hover:bg-neutral-50 transition ${
                        pathFilter === p.path ? "bg-emerald-50" : ""
                      }`}
                    >
          ...
          <p className="text-xs text-neutral-400 text-center">
            ...
            {pathFilter && (
              <button onClick={() => setPathFilter("")} className="text-emerald-600 ml-2 underline">
                Clear filter
              </button>
            )}
          </p>
