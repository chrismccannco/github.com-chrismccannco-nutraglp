          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-3">
            <div>
              ...
              <input
                ...
                disabled={!!editingId}
                className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-sm disabled:bg-neutral-50 disabled:text-neutral-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 border border-neutral-300 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              >
