    ...
    <div className="max-w-4xl">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={() => save()}
            disabled={saving}
            className="flex items-center gap-1.5 px-4 py-1.5 text-sm font-medium bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition disabled:opacity-50"
          >
      ...
      {showPalette ? (
          ...
          <div className="grid grid-cols-3 sm:grid-cols-4 gap-2">
            {fieldTypes.map((ft) => (
              <button
                ...
                className="flex items-center gap-2 px-3 py-2 text-xs text-neutral-700 bg-neutral-50 rounded-lg hover:bg-indigo-50 hover:text-indigo-700 transition"
              >
        ...
        <button
          ...
          className="w-full py-3 border-2 border-dashed border-neutral-300 rounded-xl text-sm text-neutral-400 hover:border-indigo-400 hover:text-indigo-600 transition flex items-center justify-center gap-2"
        >
  ...
  return (
    <div
      className={`bg-white border rounded-xl overflow-hidden transition ${
        dragIdx === index ? "border-indigo-400 shadow-sm" : "border-neutral-200"
      }`}
      draggable
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-1.5 text-sm border border-neutral-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500"
              />
            </div>
            <div>
                ...
                {(field.options || []).map((opt, i) => (
                  <div key={i} className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 px-2 py-1 text-sm border border-neutral-300 rounded focus:outline-none focus:ring-1 focus:ring-indigo-500"
                    />
                    <button
                      onClick={() => {
