      ...
      {!activeDocData && !query && (
        <div className="mt-10 bg-neutral-50 border border-neutral-200 rounded-xl p-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 text-sm">
            ...
            <Link href="/admin/templates" className="text-teal-700 hover:text-teal-900 no-underline">
              Templates &rarr;
            </Link>
            <Link href="/admin/sites" className="text-teal-700 hover:text-teal-900 no-underline">
              Sites &rarr;
            </Link>
            <Link href="/admin/localization" className="text-teal-700 hover:text-teal-900 no-underline">
              Localization &rarr;
            </Link>
