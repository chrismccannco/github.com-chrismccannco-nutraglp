      ...
      <div className="max-w-[1200px] mx-auto flex items-center justify-between px-6 md:px-12 py-4">
        <Link href="/" className="flex items-center gap-2.5 no-underline">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 400" fill="none" className="w-9 h-9 flex-shrink-0" aria-hidden="true">
                <path d="M 160 80 A 145 145 0 1 0 160 320" fill="none" stroke="#FFFFFF" strokeWidth="36" strokeLinecap="round"/>
                <circle cx="250" cy="200" r="60" fill="none" stroke="rgba(255,255,255,0.5)" strokeWidth="22"/>
                <rect x="310" y="186" width="50" height="28" rx="4" fill="rgba(255,255,255,0.5)"/>
                <circle cx="225" cy="200" r="16" fill="#D4B87A"/>
              </svg>
