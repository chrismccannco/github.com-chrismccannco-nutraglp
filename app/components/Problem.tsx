export default function Problem() {
  return (
    <section className="bg-forest-deep py-24 px-6 md:px-12"><div className="max-w-[720px] mx-auto">
      <p className="text-[11px] font-bold uppercase tracking-[2px] text-teal-light mb-4">
        The Problem
      </p>
      <h2 className="text-3xl md:text-4xl font-normal tracking-tight leading-tight mb-6 text-white font-display">
      ...
      <p className="text-[17px] leading-relaxed text-white/60 mb-5">
        The supplement aisle offers the opposite problem. Products claiming
        metabolic support that can&apos;t back it up. Single-ingredient
        formulas your body can&apos;t absorb. Labels that look clinical
        but aren&apos;t.
      </p>
      <p className="text-[17px] leading-relaxed text-white/60">
        <strong className="text-white font-semibold">
          There&apos;s a space between pharmaceutical efficacy and supplement
          accessibility. That&apos;s where we built NutraGLP.
        </strong>
      </p>
    </div></section>
  );
