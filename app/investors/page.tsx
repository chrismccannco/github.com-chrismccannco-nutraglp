...
{/* ═══ NAV ═══ */}
      <nav className="inv-nav">
        <div className="inv-nav-inner">
          ...
          <a href={"mailto:info@nutraglpbio.com?bcc=richard@nutrglpbio.com,chris@nutraglpbio.com&subject=Send%20me%20the%20brief"} target="_blank" rel="noopener noreferrer" className="inv-nav-cta">Request Brief</a>
        </div>
      </nav>
      ...
      <section className="inv-hero">
        <div className="inv-hero-inner">
          ...
          <div className="inv-hero-ctas">
            <a href={"mailto:info@nutraglpbio.com?bcc=richard@nutrglpbio.com,chris@nutraglpbio.com&subject=Send%20me%20the%20brief"} target="_blank" rel="noopener noreferrer" className="inv-btn-gold">Request Scientific Brief</a>
...
{/* ▓▓▓ CONTACT ▓▓▓ */}
      <section className="inv-section inv-dark" id="contact" style={{ textAlign: 'center' }}>
        <div className="inv-inner">
          ...
          <a href={"mailto:info@nutraglpbio.com?bcc=richard@nutrglpbio.com,chris@nutraglpbio.com&subject=Send%20me%20the%20brief"} target="_blank" rel="noopener noreferrer" className="inv-contact-email">info@nutraglpbio.com</a>
