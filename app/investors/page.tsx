      ...
      <section className="bg-forest py-20 px-6 md:px-12 text-center">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-16">
          <div>
            ...
            <a
              href="mailto:Richard@nutraglpbio.com"
              className="text-gold text-sm no-underline hover:text-gold-light transition"
            >
          ...
          <div>
            ...
            <p className="text-white/40 text-sm mt-1">
              Co-Founder &amp; President, Commercialization
            </p>
            <a
              href="mailto:Chris@nutraglpbio.com"
              className="text-gold text-sm no-underline hover:text-gold-light transition"
            >
