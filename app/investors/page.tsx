...
const comparables = [
  {
    ...
    signal:
      "Strategic acquirers paying platform premiums for incretin biology",
  },
  {
    ...
    value: "$2.7B (2023)",
    signal:
      "Delivery system IP and novel peptide structures command acquisition premium",
  },
  {
    ...
    signal:
      "Lilly using CVC and M&A to build ecosystem beyond internal R&D",
  },
  {
    ...
    value: "$411M (2025)",
    signal:
      "CVC actively building GLP-1 adjacent pipeline at early stage",
  },
];
  ...
  return (
    <main>
            ...
            <div>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={item} className="text-sm text-white/50 leading-relaxed pl-4 border-l border-gold/30">
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <section className="bg-forest py-20 px-6 md:px-12 text-center">
        <p className="text-[11px] font-bold uppercase tracking-[2px] text-gold mb-8">
          Contact
        </p>
        <div className="flex flex-col md:flex-row justify-center gap-8 md:gap-16">
          <div>
            ...
            <a href="mailto:Richard@nutraglpbio.com" className="text-gold text-sm no-underline hover:text-gold-light transition">
              Richard@nutraglpbio.com
            </a>
          </div>
          <div>
            ...
            <a href="mailto:Chris@nutraglpbio.com" className="text-gold text-sm no-underline hover:text-gold-light transition">
              Chris@nutraglpbio.com
            </a>
          </div>
        </div>
      </section>
