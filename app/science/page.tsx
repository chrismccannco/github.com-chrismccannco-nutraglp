...
const platformSteps = [
  ...
  },
  {
    step: "03",
    title: "Deliver",
    body: "Patent-pending nanoemulsion technology. Nanoemulsion formats have demonstrated up to 8\u00d7 bioavailability improvements in published research. The delivery system is the second moat.",
  },
];
...
const deliverySteps = [
  ...
  },
  {
    step: "2",
    title: "Absorb",
    desc: "Nanoparticles cross the intestinal epithelium through enhanced membrane permeability. Nanoemulsion formats have demonstrated up to 8\u00d7 bioavailability versus standard oral formats.",
  },
  {
    step: "3",
    title: "Activate",
    ...
    <main>
      ...
      <section className="py-20 px-6 md:px-12 bg-cream-warm">
        <FadeIn className="max-w-[720px] mx-auto">
          ...
          {/* Bioavailability Comparison Illustration */}
